...
internal static class PermissionDefinitions
{
    ...
    [
        ...
        new(PermissionCodes.SurveyApprovalView, "عرض استبيانات انتظار الاعتماد", "View surveys pending approval", null, "Approval queue listing", "Survey"),
        new(PermissionCodes.SurveyApprove, "اعتماد أو رفض الاستبيانات", "Approve or reject surveys", null, "Approve and reject workflow actions", "Survey"),
