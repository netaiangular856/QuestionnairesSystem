        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AudienceScope = table.Column<byte>(type: "tinyint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ActionPlans_Surveys_SurveyId",
                        column: x => x.SurveyId,
                        principalTable: "Surveys",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_ActionPlans_Users_OwnerUserId",
                        column: x => x.OwnerUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HelpTextAr = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    HelpTextEn = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Recommendations_Surveys_SurveyId",
                        column: x => x.SurveyId,
                        principalTable: "Surveys",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Recommendations_Users_AssignedToUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SurveyAudienceMembers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SurveyAudienceMembers_Surveys_SurveyId",
                        column: x => x.SurveyId,
                        principalTable: "Surveys",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SurveyAudienceMembers_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Initiatives_ActionPlans_ActionPlanId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SurveyResponses_SurveyParticipants_ParticipantId",
            ...
            migrationBuilder.CreateTable(
                name: "InitiativeProgressEntries",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InitiativeProgressEntries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InitiativeProgressEntries_Initiatives_InitiativeId",
                        column: x => x.InitiativeId,
                        principalTable: "Initiatives",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InitiativeProgressEntries_Users_RecordedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_QuestionAnswers_SurveyResponses_ResponseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActionPlans_OwnerUserId",
                table: "ActionPlans",
                column: "OwnerUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InboxNotifications_CreatedOnUtc",
                table: "InboxNotifications",
                column: "CreatedOnUtc");

            migrationBuilder.CreateIndex(
                name: "IX_InboxNotifications_UserId_IsRead",
                table: "InboxNotifications",
                columns: new[] { "UserId", "IsRead" });

            migrationBuilder.CreateIndex(
                name: "IX_InitiativeProgressEntries_InitiativeId",
                table: "InitiativeProgressEntries",
                column: "InitiativeId");

            migrationBuilder.CreateIndex(
                name: "IX_InitiativeProgressEntries_RecordedAtUtc",
                table: "InitiativeProgressEntries",
                column: "RecordedAtUtc");

            migrationBuilder.CreateIndex(
                name: "IX_InitiativeProgressEntries_RecordedByUserId",
                table: "InitiativeProgressEntries",
                column: "RecordedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Initiatives_ActionPlanId",
                table: "Initiatives",
                column: "ActionPlanId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Recommendations_AssignedToUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Recommendations_SurveyId",
                table: "Recommendations",
                column: "SurveyId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SurveyAudienceMembers_SurveyId",
                table: "SurveyAudienceMembers",
                column: "SurveyId");

            migrationBuilder.CreateIndex(
                name: "IX_SurveyAudienceMembers_SurveyId_Email",
                table: "SurveyAudienceMembers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SurveyAudienceMembers_SurveyId_UserId",
                table: "SurveyAudienceMembers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SurveyAudienceMembers_UserId",
                table: "SurveyAudienceMembers",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SurveyResponses_ParticipantId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SurveyTemplates_IsArchived",
